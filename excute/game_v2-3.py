...
class ComMoraImgInsert():
    def __init__(self) -> None:
        ...
        self.rock_img = cv2.imread(f'{os.path.dirname(__file__)}/../images/base/rock.png', -1)
        self.paper_img = cv2.imread(f'{os.path.dirname(__file__)}/../images/base/paper.png', -1)
        self.scissors_img = cv2.imread(f'{os.path.dirname(__file__)}/../images/base/scissors.png', -1)
...
moragame = MoraGame(f"{os.path.dirname(__file__)}/../model_pt/1002.pt")
moragame.play()
