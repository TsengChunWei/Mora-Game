...
class myclass():
    ...
    def detect(self, model_pt, video_file):
...
model_pt = f'{os.path.dirname(__file__)}/1002.pt' # .py 和 .pt同一個資料夾
folder = "C:/Cdisk_main/Document/python_work/AI_Image_Recognize/Project/model_pt"
model_pt = f'{folder}/1002.pt' # 絕對路徑
video_file = 'C:/Cdisk_main/Document/python_work/AI_Image_Recognize/Project/test_video/test_video.mp4'
detect_test.detect(model_pt, video_file)
